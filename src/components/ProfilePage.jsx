    ...
    <div className="bg-white p-8 rounded-xl shadow-lg border border-blue-100 animate-fade-in max-w-3xl mx-auto my-8">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-8">
        <div className="flex-shrink-0 relative">
          ...
          />
          <label htmlFor="profile-image-upload" className="absolute bottom-0 right-0 bg-blue-500 text-white p-2 rounded-full cursor-pointer hover:bg-blue-600 transition duration-200 shadow-md">
            <Upload size={18} />
            <input
        ...
        <div className="flex-grow text-center md:text-left">
          {isEditingName ? (
            <div className="flex items-center justify-center md:justify-start gap-2">
              ...
              />
              <button onClick={handleSaveName} className="p-2 bg-green-500 text-white rounded-full hover:bg-green-600 transition duration-200">
                <Save size={18} />
              </button>
            </div>
          ) : (
            <h3 className="text-2xl font-semibold text-gray-900 mb-1 flex items-center justify-center md:justify-start gap-2">
              {userName}
              <button onClick={() => setIsEditingName(true)} className="p-1 bg-gray-200 rounded-full text-gray-600 hover:bg-gray-300 transition duration-200">
                <Edit size={16} />
              </button>
            </h3>
          )}
